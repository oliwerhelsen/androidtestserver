...
ParseRequest.postData = function() {
  ...
  XHR.POST('http://ioliwerapiserver.herokuapp.com/parse/classes/GameScore');
}
...
ParseRequest.getData = function() {
  ...
  XHR.GET('http://ioliwerapiserver.herokuapp.com/parse/classes/GameScore');
}
...
ParseRequest.postCloudCodeData = function() {
  ...
  XHR.POST('http://ioliwerapiserver.herokuapp.com/parse/functions/hello');
}
